...
import { countProjects, listProjectsWithMilestones } from "@/lib/data";
...
export default async function ProjectsPage({
  ...
  const totalCount = await countProjects(user.id);

  const allProjects = await listProjectsWithMilestones({ status, q, vendorUserId: user.id });
